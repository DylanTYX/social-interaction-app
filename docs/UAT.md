...
| Backend | Supabase project running; migrations applied (`0001`–`0005`, including resumes and the atomic-turn RPC) |
...
- “If something confuses you, say what you *expected* to happen.”
...
| ID | Test | Steps | Expected | Pass? | Notes |
|----|------|-------|----------|-------|-------|
| V1 | Mic permission | Allow microphone | Recording UI active | ☐ | |
| V2 | Deny mic | Block microphone | Clear message / fallback path | ☐ | |
...
*Update this document when you fix bugs or add features — bump the version in the header.*
