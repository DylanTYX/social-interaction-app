...
- **Ready.** Only what you act on: for voice, the microphone check with a status icon at text size, then the voice toggles; for text, one line offers switching to voice. Then the in-interview toggles. No reading-only cards.
