...
export const DRILL_QUESTIONS: DrillQuestion[] = [
  ...
  },
  {
    ...
    category: "behavioral",
    prompt:
      "Describe the most challenging project you've worked on and your specific role.",
  },
  {
    id: "b7",
    category: "behavioral",
  ...
  // Leadership
  {
    id: "l1",
    category: "leadership",
    prompt: "Tell me about a time you led a team through a difficult change.",
  },
  {
    id: "l2",
    category: "leadership",
    prompt: "Describe a time you had to motivate an underperforming teammate.",
  },
  {
    id: "l3",
    category: "leadership",
    prompt:
      "Tell me about a decision you made that was unpopular with your team.",
  },
  {
    id: "l4",
    category: "leadership",
    prompt: "Describe how you've delegated work when you were overloaded.",
  },
  {
    id: "l5",
    category: "leadership",
  ...
  },
  {
    id: "s5",
    category: "screening",
    prompt: "What's your greatest professional strength, with an example?",
  },

  // Technical (SWE)
  {
    id: "t1",
    category: "technical_swe",
    prompt:
  ...
  // Case
  {
    ...
    category: "case",
    prompt:
      "How many electric vehicles will be sold in your country next year? Estimate out loud.",
  },
  {
    id: "c2",
    category: "case",
    prompt:
      "A SaaS product's monthly churn just doubled. How do you investigate?",
  },
  {
    id: "c3",
    category: "case",
    prompt:
      "Our checkout conversion dropped 15% last week. Walk me through how you'd diagnose it.",
  },
  {
    id: "c4",
    category: "case",
    prompt:
      "How would you decide whether to build or buy an internal analytics tool?",
  },
  ...
  },
  {
    id: "h2",
    category: "hr",
    prompt: "What would make you turn down an offer from us?",
  },
  {
    id: "h3",
    category: "hr",
    prompt:
      "Talk me through your notice period and what you would need to hand over.",
  },
  {
    id: "h4",
    category: "hr",
  ...
  },
  {
    id: "h5",
    category: "hr",
    prompt: "Describe the team culture you do your best work in.",
  },
 ...
 *
 * The bank is keyed by drill category, and several categories map onto one
 * round type (`leadership` is a behavioural round), so this walks the mapping
 * that `DRILL_CATEGORIES` already encodes.
 *
